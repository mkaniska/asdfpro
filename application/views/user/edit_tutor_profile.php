        ...
        <form id="contact-form" name="contact-form" method="post" action="<?php echo base_url();?>user/updateprofile">
          <table width="100%" border="0" cellspacing="0" cellpadding="5" style="margin-left:20px;">
                ...
                <tr>
                  ...
                  <td>
                      <input type="text" name="experience" id="experience" value="<?php echo $info->tutor_experience;?>" />
                  </td>
                  <td id="errOffset">&nbsp;</td>
					<td><label for="work_status">* Current Work Status</label></td>
                  <td>
                    <input type="radio" name="work_status" id="work_status1" value="Institute" checked="checked" /> 
                    <label for="work_status1">Institute</label>
                    <input type="radio" name="work_status" id="work_status2" value="Self" <?php if($info->tutor_current_work_status=='Self'){?> checked="checked"<?php }?> /> 
                ...
                <tr>
                  ...
                  <td colspan="4">
                      <input type="text" name="institute" id="institute" value="<?php echo $info->tutor_institute;?>" size="45" />
                  </td>
                  <td id="errOffset">&nbsp;</td>						  
                </tr>
                <tr>
                  ...
                  <td colspan="4">
                      <textarea rows="5" cols="90" name="skills" id="skills"><?php echo $info->tutor_skills;?></textarea> </br>
