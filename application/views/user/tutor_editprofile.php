    ...
    <div id="contact_form" class="col_2_new">
        ...
        <form id="contact-form" name="contact-form" method="post" action="<?php echo base_url();?>user/updateprofile">
          <table width="100%" border="0" cellspacing="0" cellpadding="5" style="margin-left:10px;">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="5" style="margin-left:10px;">
                <tr>
                  <td width="10%"><label for="experience">Experience</label></td>
                  <td width="30%">
                      <input type="text" name="experience" id="experience" value="<?php echo $data_restore['tutor_experience'];?>" />
                  </td>
                  <td width="10%" id="errOffset">&nbsp;</td>
                  <td width="10%"><label for="skills">Skills</label></td>
                  <td width="30%">
                      <input type="text" name="skills" id="skills" value="<?php echo $data_restore['tutor_skills'];?>" />
                  </td>
                  <td width="10%" id="errOffset">&nbsp;</td>						  
                </tr>
                <tr>
                  <td width="10%"><label for="work_status">Current Work Status</label></td>
                  <td width="30%">
                    <input type="radio" name="work_status" id="work_status1" value="Institute" checked="checked" /> 
                    <label for="work_status1">Institute</label>
                    <input type="radio" name="work_status" id="work_status2" value="Self" <?php if($data_restore['tutor_current_work_status']=='self'){?> checked="checked"<?php }?> /> 
                    <label for="work_status2">Self</label>
                  </td>
                  <td width="10%" id="errOffset">&nbsp;</td>
                  <td width="10%"><label for="institute">Institute</label></td>
                  <td width="30%">
                      <input type="text" name="institute" id="institute" value="<?php echo $data_restore['tutor_institute'];?>" />
                  </td>
                  <td width="10%" id="errOffset">&nbsp;</td>						  
                </tr>
                <tr>
